...
public class SearchAPI extends AsyncTask<String, String, String> {
    ...
    public SearchAPI(MainActivity ma, String t) {
        this.m = ma;
        this.title = t;
    }
    ...
    protected String doInBackground(String... urls) {
        ...
        Request request = new Request.Builder()
                .url("https://cheapshark-game-deals.p.rapidapi.com/deals?lowerPrice=0&steamRating=0&title=" + title +"&desc=0&output=json&steamworks=0&sortBy=Deal%20Rating&AAA=0&pageSize=60&exact=0&upperPrice=50&pageNumber=0&onSale=0&metacritic=0&storeID=1%2C2%2C3")
                .get()
